...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["organization", "status"], name="financials__organiz_482453_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                ...
                name="financials__organiz_67165b_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="financials__organiz_11782c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="ledgerentry",
            index=models.Index(
                fields=["account", "posted_at"], name="financials__account_af4e3e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ledgerentry",
            index=models.Index(
                fields=["transaction_id"], name="financials__transac_5dbc5b_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="ledgerentry",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization", "created_at"],
                name="financials__organiz_7fd307_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["organization", "status"], name="financials__organiz_20efff_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="paymentintent",
            index=models.Index(
                fields=["organization", "status"], name="financials__organiz_5267c6_idx"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization", "status"], name="financials__organiz_579da9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="usagerecord",
            index=models.Index(
                fields=["organization", "feature_key", "recorded_at"],
                name="financials__organiz_9eb1a6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="einvoice",
            index=models.Index(
                fields=["organization", "status"], name="financials__organiz_b278da_idx"
            ),
        ),
    ]
